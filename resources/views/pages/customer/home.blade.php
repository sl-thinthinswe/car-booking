        ...
        <div>
          ...
          <div class="flex items-center border border-gray-300 rounded overflow-hidden w-max">
            ...
            <input
              ...
              value="1"
              readonly
              class="w-14 text-center py-2 border-l border-r border-gray-300 focus:outline-none"
            />
    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-center">
        ...
        <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition">
          ...
          <h3 class="text-lg font-semibold mb-2">100+ Car Operators</h3>
          <p class="text-gray-600 mb-4">Choose from 100+ major Car operators covering 200 destinations.</p>
        ...
        <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition">
          ...
          <h3 class="text-lg font-semibold mb-2">Instant Booking</h3>
          <p class="text-gray-600 mb-4">Book your trip in less than 3 minutes. Instant confirmation after payment.</p>
          <a href="#" class="text-blue-500 font-medium hover:underline">Learn More →</a>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition">
          ...
          <p class="text-gray-600 mb-4">Pay with WaveMoney, CBPay, KBZPay and AYAPay.</p>
          <a href="#" class="text-blue-500 font-medium hover:underline">Learn More →</a>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow hover:shadow-md transition">
          ...
          <h3 class="text-lg font-semibold mb-2">Help 24/7</h3>
          <p class="text-gray-600 mb-4">Our support center is available 24/7 for your questions and concerns.</p>
          <a href="#" class="text-blue-500 font-medium hover:underline">Learn More →</a>
        </div>
      </div>
    </div>
...
<script>
  ...
  incrementBtn.addEventListener('click', () => {
    let count = parseInt(seatInput.value);
...
<section class="bg-white py-8 px-4 sm:px-8 lg:px-16">
  <div class="max-w-7xl mx-auto text-center">
    ...
    <div class="flex flex-wrap justify-center items-center gap-16">
      ...
      <!-- WaveMoney -->
      <img src="{{ asset('images/789a89a0da9acdf8b41fad39f69b9531.jpg') }}" alt="Car Icon" class="w-20 h-20 rounded-xl" />
      <!-- KBZPay -->
      <img src="{{ asset('images/11f074fe04271ca1f562331d873344f8 (1).jpg') }}" alt="Car Icon" class="w-20 h-20" />
      <!-- CBPay -->
      <img src="{{ asset('images/cartoon.jpg') }}" alt="Car Icon" class="w-20 h-20" />
      <!-- AYA -->
      <img src="{{ asset('images/photo_2025-07-03_20-33-44.jpg') }}" alt="Car Icon" class="w-20 h-20" />
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
      @php
        $popularRoutes = [
          [
            ...
            'desc' => '(Tomorrow - 1 seat - Myanmar)',
            'image' => 'images/Mandalay.jpg',
            'link' => '#'
          ],
          [
            'title' => 'Yangon - Bagan',
          ...
          [
            'title' => 'Yangon - Naypyidaw (Bawga)',
            'desc' => '',
            'image' => 'images/Nay.jpg',
            'link' => '#'
          ],
          [
            'title' => 'Yangon - Mawlamyine',
            'desc' => '',
            'image' => 'images/Maw.jpg',
            'link' => '#'
          ],
        ];
      @endphp
      ...
      @foreach($popularRoutes as $route)
        <div class="group relative rounded-xl overflow-hidden shadow-md h-72">
          ...
          <!-- Hover Overlay -->
          <div class="absolute inset-0 bg-black bg-opacity-80 flex flex-col justify-center items-center
                      opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center px-4">
            <h3 class="text-white text-lg font-bold mb-2">{{ $route['title'] }}</h3>
            @if($route['desc'])
              <p class="text-sm text-white mb-4">{{ $route['desc'] }}</p>
            @endif
            <a href="{{ $route['link'] }}"
               class="bg-white text-cyan-700 hover:bg-cyan-700 hover:text-white px-4 py-2 rounded-full font-medium transition">
              Search Trip
            </a>
          </div>
        </div>
